             ...
             count: (NSUInteger) count
{
    if (_capacityOfCharacters < _numberOfCharacters + count) {
        ...
        _characters = NSZoneRealloc(NULL, _characters,
                                    _capacityOfCharacters * sizeof(unichar));
        _characterRects = NSZoneRealloc(NULL, _characterRects,
                                        _capacityOfCharacters * sizeof(NSRect));
    }
...
- (NSString *) string {
    ...
    return [[[NSString alloc] initWithCharactersNoCopy: _characters
