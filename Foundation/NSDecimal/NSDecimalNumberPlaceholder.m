...
- initWithCoder: (NSCoder *) coder {
    if ([coder allowsKeyedCoding]) {
        ...
        // NSInteger mantissaByteOrder=[coder
        // decodeIntegerForKey:@"NS.mantissa.bo"]; // byte order?? NSUInteger
        // byteLength=0; const uint8_t *mantissa=[coder
        // decodeBytesForKey:@"NS.mantissa" returnedLength:&byteLength];
    }

    // We should warn here, but this needs to be ignored for an app, maybe at
    // least construct a float?
