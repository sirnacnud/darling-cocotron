...
// #define NSABIasm_jmp_objc_msgSend_stret __asm__("jmp
// _objc_msgSend_stret@PLT");
...
// both of these suck, we should be using NSMethodSignature types to extract the
// frame and create the NSInvocation here
#ifdef __sparc__
...
#ifdef GCC_RUNTIME_3
// TODO Forwarding currently only works for methods returning types not wider
// than id. The result is cropped to min(sizeof(returntype_of_forward_imp),
// sizeof(returntype_of_selector || id)).
