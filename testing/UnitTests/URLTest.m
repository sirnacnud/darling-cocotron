...
#define TEST_URL(rel, abs)                                                     \
    do {                                                                       \
        NSURL *relative = [NSURL URLWithString: rel relativeToURL: baseUrl];   \
        STAssertEqualObjects([relative absoluteString], abs,                   \
                             @"URL %@ relative to %@ should resolve to %@",    \
                             rel, baseUrl, abs);                               \
    } while (0)
