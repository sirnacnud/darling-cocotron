...
/* hunspelldll.h is a rough C cover over the C++ library, if more functionality
   is needed use the C++ library directly.
 */

// hunspell includes use 'near' identifier for method name, but windows.h
// #defines near However, windows.h should not be included in public Foundation
// headers, so that needs to be cleaned up. For now we #undef near
