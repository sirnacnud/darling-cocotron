...
void buildUnicharData() {
    ...
    // We're interested by fields 0 (hexa of char), 4 (bidi type) and 9 (the
    // char has some mirrored char) macro to help building the text->const
    // dictionary ->  [NSNumber numberWithInt:ON], @"ON"
