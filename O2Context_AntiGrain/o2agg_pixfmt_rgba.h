...
// Addition custom ops:
template <class ColorT, class Order>
struct comp_op_rgba_plus_darker {
    typedef ColorT color_type;
    typedef Order order_type;
    typedef typename color_type::value_type value_type;
    typedef typename color_type::calc_type calc_type;
...
struct comp_op_adaptor_rgba {
    ...
    static AGG_INLINE void blend_pix(unsigned op, value_type *p,
        ...
        unsigned ca,
        unsigned cover) {
        comp_op_table_rgba<ColorT, Order>::g_comp_op_func[op](p, (cr * ca + base_mask) >> base_shift,
...
struct comp_op_adaptor_clip_to_dst_rgba {
    ...
    static AGG_INLINE void blend_pix(unsigned op, value_type *p,
        ...
        comp_op_table_rgba<ColorT, Order>::g_comp_op_func[op](p, (cr * da + base_mask) >> base_shift,
